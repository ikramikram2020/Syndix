...
export default function CallToAction() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[var(--syndix-navy)] via-[var(--syndix-navyDeep)] to-[var(--syndix-teal)] py-20">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden opacity-10">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-white rounded-full blur-3xl"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-[var(--syndix-teal)] rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[var(--syndix-orange)] rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative max-w-[900px] mx-auto px-6 lg:px-12 text-center z-10">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full mb-6">
          <span className="w-1.5 h-1.5 rounded-full bg-[var(--syndix-teal)] animate-pulse"></span>
        ...
        <div className="flex flex-wrap gap-4 justify-center mb-8">
          <Link
            href="/register"
            className="group inline-flex items-center gap-2 px-8 py-3.5 bg-[var(--syndix-orange)] hover:bg-[var(--syndix-orangeDeep)] text-white font-bold rounded-xl transition-all duration-200 hover:scale-105 hover:shadow-2xl shadow-lg"
          >
            Start Free Trial
        ...
        <div className="flex flex-wrap gap-4 justify-center text-sm text-white/60">
          <span className="flex items-center gap-1.5">
            <span className="w-1 h-1 rounded-full bg-[var(--syndix-teal)]"></span>
        ...
        <div className="absolute -bottom-10 -right-10 w-32 h-32 bg-[var(--syndix-orange)]/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
    </section>
  );
}